...
public class Api {
     ...
     * @param keyDescriptions A String[] (Array[String]) of the key descriptions as an inherit array. i.e. ("modName",
     *                        "key.hotbar1", "key.hotbar2")
     */
    public static void registerMod(String modname, String... keyDescriptions) {
        try {
            Class.forName("modwarriors.notenoughkeys.keys.KeyHelper")
                    .getMethod("registerMod", String.class, String[].class).invoke(null, modname, keyDescriptions);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
