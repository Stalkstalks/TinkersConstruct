...
public class KeyBindingPressedEvent extends Event {
    ...
    /**
     * Use this variable to check if your key is pressed. DO NOT check KeyBinding.getIsKeyPressed(). That value will
     * return only if the main key is pressed or not.
     * 
    ...
    /**
     * Called with the passed keyBinding and modifiers. Subscribe to this event so activate a keybinding when triggered.
     *
