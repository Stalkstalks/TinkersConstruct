...
public class HealthBarRenderer extends Gui {
    ...
    public void renderHealthbar(RenderGameOverlayEvent.Pre event) {
        ...
        final int TOP = (mc.theWorld.getWorldInfo().isHardcoreModeEnabled() ? 45 : 0);
        int tinkerTextureY = (mc.theWorld.getWorldInfo().isHardcoreModeEnabled() ? 27 : 0);
        ...
        for (int i = MathHelper.ceiling_float_int((healthMax + absorbMax) / 2.0F) - 1; i >= 0; --i) {
