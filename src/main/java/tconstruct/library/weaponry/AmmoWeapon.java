 ...
 */
@Optional.InterfaceList({ @Optional.Interface(modid = "battlegear2", iface = "mods.battlegear2.api.IUsableItem"),
...
public abstract class AmmoWeapon extends AmmoItem
        implements IAccuracy, IWindup, IUsableItem, zeldaswordskills.api.item.ISword, dynamicswordskills.api.ISword {
